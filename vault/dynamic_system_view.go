...
func (d dynamicSystemView) LookupPlugin(ctx context.Context, name string, backendType consts.BackendType) (*pluginutil.PluginRunner, error) {
	if d.core == nil {
	...
	r, err := d.core.pluginCatalog.Get(ctx, name, backendType)
	if err != nil {
		return nil, err
	}
	if r == nil {
