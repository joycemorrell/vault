...
func (c *PluginCatalog) Get(ctx context.Context, name string, backendType consts.BackendType) (*pluginutil.PluginRunner, error) {
	c.lock.RLock()
	...
	if factory, ok := builtinplugins.Get(name, backendType); ok {
